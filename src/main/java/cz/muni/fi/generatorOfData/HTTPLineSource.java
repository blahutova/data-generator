...
public class HTTPLineSource implements LineSource {
    ...
    private Long parseToTimestamp(String date){
    ...
    private Long getTimestampFromDate(String[] partsOfDate) {
        ...
        timestamp.set(Calendar.HOUR, Integer.parseInt(partsOfDate[1]));
    ...
    private int getDay(String dayOfTracing){
